...
export default class FileItem extends Item {
  ...
  constructor(name = "", coordinates: Coordinates, textContent = "", source = {} as FileItem) {
  ...
  get copy(): FileItem {
    return new FileItem(`${this.name} copy`, this.coordinates, this.textContent, this.source);
  }
}
