  ...
  <MoveAndResizeArea :itemDialog="itemDialog">
    ...
    <template #default>
      <div
        ...
        ref="itemContentRef"
      >
        <!-- TODO: we should not pass height to the component , we should set the height directly to the component
...
const applicationPath = computed(() => {
  return `${import.meta.env.BASE_URL}/src/components/apps/${props.itemDialog.applicationToOpen}.vue`;
});
