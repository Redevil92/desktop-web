...
export const createFilesStructure = async () => {
  ...
  if (!exists) {
    ...
    try {
      ...
      await fileSystem.createFile("my PC/Desktop/Browser.lnk", JSON.stringify(browserElement), "utf8", false);
      saveDesktopFilePosition("my PC/Desktop/Browser.lnk", { x: 120, y: 0 });

      const dukeNuken: LinkData = { fileTypeToOpen: "Duke Nukem 3D" };
      await fileSystem.createFile("my PC/Desktop/Duke Nukem 3D.lnk", JSON.stringify(dukeNuken), "utf8", false);
      ...
      await fileSystem.createFile("my PC/Desktop/CV-Stefano_Badalucco.pdf", pdfElement, "utf8", false);
      ...
      await fileSystem.createFile("my PC/Desktop/About me/ClimbingArco.jpeg", imageData, "utf8", false);

      imageData = (await readLocalFile("./files/30....jpeg")) as string;
      await fileSystem.createFile("my PC/Desktop/About me/30....jpeg", imageData, "utf8", false);

      imageData = (await readLocalFile("./files/Olivia.jpeg")) as string;
      await fileSystem.createFile("my PC/Desktop/About me/Olivia.jpeg", imageData, "utf8", false);

      imageData = (await readLocalFile("./files/Me&Olivia.jpeg")) as string;
      await fileSystem.createFile("my PC/Desktop/About me/Me&Olivia.jpeg", imageData, "utf8", false);
    } catch (error) {
